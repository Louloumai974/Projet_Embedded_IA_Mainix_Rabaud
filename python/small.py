...
def plot_history(history):
    ...
    plt.savefig("./CNN/analys/loss_model_small.png")
    plt.show()
    ...
    plt.savefig("./CNN/analys/accuracy_model_small.png")
    plt.show()
...
def build_model(data):
       ...
       # model = models.Sequential()
        ...
        # Dense layer
       # model.add(Conv2D(32, (3, 3), padding='same', input_shape=data.input_shape))
...
class dataset:
    def __init__(self):
        ...
        self.x_train = np.load('../NPY_Dataset/train/esca_dataset_xtrain_model_small.npy')
        self.y_train = np.load('../NPY_Dataset/train/esca_dataset_ytrain_model_small.npy')
        self.x_test = np.load('../NPY_Dataset/test/esca_dataset_xtest_model_small.npy')
        self.y_test = np.load('../NPY_dataset/test/esca_dataset_ytest_model_small.npy')
        self.x_validation = np.load('../NPY_Dataset/validation/esca_dataset_xvalidation_model_small.npy')
        self.y_validation = np.load('../NPY_Dataset/validation/esca_dataset_yvalidation_model_small.npy')
