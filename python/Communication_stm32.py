...
def send_NN_inputs_to_STM32(esca_set, ser):
    ...
    tmp = esca_set.x_sample.reshape((85,45))
...
if __name__ == '__main__':
    ...
    with serial.Serial("COM11", 115200, timeout=1) as ser: # COM5 for H743 (nucleo) and COM6 for F411 (Nucleo)
        ...
        used_model = "./CNN/H5/small/model_small_b32.h5"

        # X_test and Y_test dataset available for inference
        path_xtest = "../NPY_Dataset/test/esca_dataset_xtest_model_small.npy"
        path_ytest = "../NPY_Dataset/test/esca_dataset_ytest_model_small.npy"
